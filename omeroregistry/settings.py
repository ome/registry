    ...
    'handlers': {
        'default': {
            ...
            'filename': os.path.join(
                LOGDIR, 'OMEROregistry.log').replace('\\', '/'),
        ...
        'request_handler': {
            ...
            'class': LOGGING_CLASS,
            'filename': os.path.join(
                LOGDIR, 'OMEROregistry_brokenrequest.log').replace('\\', '/'),
            'maxBytes': 1024*1024*5,  # 5 MB
            'backupCount': 10,
...
INSTALLED_APPS = (
    ...
    'omeroregistry.registry',
)

ROOT_URLCONF = 'omeroregistry.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'omeroregistry.wsgi.application'
...
EMAIL_HOST_USER = ''
EMAIL_PORT = 25
EMAIL_SUBJECT_PREFIX = '[OMERO.registry]'
EMAIL_USE_TLS = False
SERVER_EMAIL = None
...
DOWNLOAD_PAGE = "http://downloads.openmicroscopy.org/latest-stable/omero"
